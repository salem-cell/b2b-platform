...
export function createInitialState() {
  return {
    ...
    // v6: سلة الإضافة من كتالوج B2B + إدارة صور المنتجات
    bkt: {},                                        // {pid: true} — سلة طلب الإضافة
    imgPid: null, imgUrl: '',                       // نافذة صورة المنتج (إدارة الكتالوج)

    // v7: التحصيل والائتمان — حقول واجهة
    colSel: null,                                   // ملف التحصيل المفتوح صفحةً
    colBack: 'fintu',                               // وجهة زر العودة (fintu | clientdet | wallet)
    dhOpen: false,                                  // طي/فرد سجل تعديل الاستحقاق
    waAmt: '', waMonths: 1, waNote: '',
    wdDate: '', wdNote: '', wpDate: '', wpAmt: '',
    ccpDate: '', ccpAmt: '', cpAmt: '', wpaAmt: '',
    nlAmt: '', ctAmt: '', ccrDate: '', ccrWhy: '',
    ...
    // v7: طلبات الأجل والمهلة (عينات)
    finReqs: [
      { id: 'FRQ-203', clientId: 2, kind: 'ajel', amt: 40000, months: 2, note: 'توسعة فرع القيروان — موسم الصيف', st: 'pend', date: 'اليوم 09:40' },
      { id: 'FRQ-202', clientId: 3, kind: 'promise', amt: 5000, toDate: '2026-08-25', st: 'ok', fileId: 'COL-302', date: 'أمس' },
      { id: 'FRQ-201', clientId: 3, kind: 'delay', toDate: '2026-08-20', note: 'تأخر تحصيل مستحقاتنا من عميل حكومي', st: 'ok', fileId: 'COL-302', date: '10 أغسطس' },
    ],

    // v7: ملفات التحصيل (عينات) — بروست الخليج متأخر، ومطاعم البلدة ملف مغلق موثق
    colFiles: [
      { id: 'COL-302', clientId: 3, inv: 'INV-9276', ref: 'مشتريات يوليو الآجلة', amt: 9200, origAmt: 12400,
        created: '2026-07-05', due: '2026-08-20', lateDays: 12, stage: 2,
        promise: { date: '2026-08-25', amt: 5000 },
        dueHist: [{ old: '2026-08-07', to: '2026-08-20', why: 'مهلة معتمدة — تأخر تحصيل عميل حكومي', d: '10 أغسطس 11:20' }],
        log: [
          { t: 'فُتح ملف التحصيل تلقائيًا بعد 7 أيام من الاستحقاق دون سداد', d: '14 أغسطس 09:00' },
          { t: 'أُرسل تذكير سداد ودي (رسالة نصية + إشعار بالتطبيق)', d: '14 أغسطس 09:05' },
          { t: 'سجّل B2B دفعة 3,200 ر.س — المتبقي 9,200 ر.س', d: '15 أغسطس 13:40' },
          { t: 'صُعّد الملف إلى «مطالبة رسمية» لعدم اكتمال السداد', d: '17 أغسطس 10:15' },
          { t: 'سجّل العميل وعد سداد 5,000 ر.س بتاريخ 2026-08-25 — يُراقب تلقائيًا', d: '18 أغسطس 16:30' },
        ],
        st: 'open' },
      { id: 'COL-301', clientId: 1, inv: 'INV-9280', ref: 'مشتريات يونيو الآجلة', amt: 0, origAmt: 6180.75,
        created: '2026-06-12', due: '2026-07-10', lateDays: 0, stage: 1, dueHist: [],
        log: [
          { t: 'فُتح ملف التحصيل بعد تجاوز الاستحقاق بيومين', d: '12 يوليو 09:00' },
          { t: 'سدد العميل كامل المستحق 6,180.75 ر.س من المحفظة — أُغلق الملف ✓', d: '13 يوليو 11:25' },
        ],
        st: 'closed' },
    ],
